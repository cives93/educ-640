...
data <- read.sav(here("Lab 2/Lab2_Vocab.sav"), use.value.labels = T)
```
...
``` {r}
data_import <- import(here("Lab 2/Lab2_Vocab.sav"))
head(data_import)
```
...
``` {r}
needs(misty)
l2_data <- misty::read.sav(here("Lab 2/Lab2_Vocab.sav"), 
...
```{r, echo = F}
l1_data <- misty::read.sav(here("Lab 1/Lab1_Vocab.sav"), 
                        use.value.labels = TRUE)
```
...
## Specified Contrasts
``` {r, echo = F}
l3_data <- misty::read.sav(here("Lab 3/Lab3_Vocab.sav"),
                        use.value.labels = TRUE)
```
