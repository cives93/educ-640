...
To create boxplots across three IVs, we will assign `Area` to the x-axis and facet Temp and Size using `facet_grid`.
...
`afex::aov_car` is what we have used the last few weeks for our within-subjects and mixed ANOVAs. While it is convenient in that it works with `emmeans` it requires an ID variable. I'll demonstrate the process if you wanted to continue using it.
